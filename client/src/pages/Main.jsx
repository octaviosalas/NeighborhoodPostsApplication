                ...
                <div className="flex flex-col gap-6 sm:gap-4 mt-9 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <div>
                        <div className="mt-2">
                            ...
                            ring-pallete-grey focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 h-[100px]" />           
                        </div>
                    </div>
                    ...
                    <div className='justify-center text-center mt-6 bg-blue-950 border rounded-xl'>
                        <button className=' bg-blue-950 border-none  text-white'>Public Report</button>
                    </div>
                </div>
            </form>
