...
const SignIn = () => {
  ...
  return (
    <div className=' mt-12 justify-center'>
       <main className='flex justify-center items-center gap-10 sm:gap-0 my-6 mx-2 sm:mx-5 md:mx-10 bg-gray-200 rounded-xl w-80 sm:w-96'>
            <div className="basis-1/2 w-[50vh] flex flex-1 flex-col sm:gap-0 justify-center p-6 py-8 sm:py-6 lg:px-8 rounded-lg bg-opacity-60 shadow-md">
                <h2 className="text-center text-2xl font-PoppinsBold leading-9 tracking-tight text-pallete-black">Sign In</h2>
                    <div className="flex flex-col gap-6 sm:gap-4 mt-9 sm:mx-auto sm:w-full sm:max-w-sm">
                        <div>
                            <div className="mt-2">
                                ...
                                ring-pallete-grey focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 text-black bg-white dark:bg-white dark:text-black" onChange={(e) => setEmail(e.target.value)}/>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="mt-2 flex flex-col">
                                ...
                                ring-pallete-grey focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 text-black bg-white dark:bg-white dark:text-black"  onChange={(e) => setPassword(e.target.value)}
                                />
                        ...
                        <div className='flex flex-col gap-3 mt-5 mx-auto items-center justify-center'>              
                            ...
                            {showBackendMessage ?   <p className='text-blue-950 font-bold mt-4 text-xs sm:text-sm'><b>{messageError}</b></p> : null}
                        </div>
                    </div>
