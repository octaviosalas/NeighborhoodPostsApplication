...
const AnnounceResolvedComplaint = ({ pubChoosen, publicationId,creatorName,creatorId,closeModalShare,profileImage}) => {
  ...
  return (
    <div>
    <p className="font-bold text-xs underline cursor-pointer" onClick={() => openModalTwo()}>
    AnnounceResolvedComplaint
    </p>
...
export default AnnounceResolvedComplaint
