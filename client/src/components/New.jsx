                ...
                <div className="flex flex-col gap-6 sm:gap-4 mt-9 sm:mx-auto sm:w-full max-w-fit-contain">
                            ...
                            <div>
                                <div className="mt-2 mr-2">
                                    <input  id="Email" name="user" placeholder="Title.." type="text" required className="input input-sm block w-72 xxxs:w-80 xxs:w-full border border-black font-PoppinsRegular 
                            ...
                            <div className='mr-2'>
                                <div className="mt-2">
                                    <input  id="Contraseña" name="Contraseña" placeholder="Categoria.." type="text" required className="input input-sm block w-72 xxxs:w-80 xxs:w-full border border-black font-PoppinsRegular 
                            ...
                            <div>
                                <div className="mt-2">
                                    <textarea  id="Contraseña" name="Contraseña" placeholder="Description.." type="text" required className="input input-sm block w-72 xxxs:w-80 xxs:w-full border border-black font-PoppinsRegular 
                        ...
                        <div>
                                <div className="mt-2">
                                    <input  id="Contraseña" name="Contraseña" placeholder="Ubication.." type="text" required className="input input-sm block w-72 xxxs:w-80 xxs:w-full border border-black font-PoppinsRegular 
                                    ring-pallete-grey focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 "  onChange={(e) => setUbication(e.target.value)}/>           
                                </div>

                                <div className="mt-2">
                                    <input  id="Contraseña" name="Contraseña" placeholder="Adress.." type="text" required className="input input-sm block w-72 xxxs:w-80 xxs:w-full border border-black font-PoppinsRegular 
                                ...
                                <div className='flex justify-center items-center w-72 xxxs:w-80 xxs:w-full gap-4'>
                               ...
                               {showSuccesfullyMsgBackend ? 
                                    <div className='justify-center text-center mt-6 bg-blue-950 border rounded-xl w-72 xxxs:w-80 xxs:w-full max-w-fit-contain'>
